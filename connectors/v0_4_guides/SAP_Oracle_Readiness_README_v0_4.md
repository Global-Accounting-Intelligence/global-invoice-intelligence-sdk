# SAP_Oracle_Readiness Connector

## Purpose

Architecture placeholder for future SAP Business One, SAP S/4HANA, Oracle Fusion, and Dynamics. Do not implement before MVP proof.
